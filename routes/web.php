...
Route::get('/admin/vacancies/{id}', 'App\Http\Controllers\AdminVacancyController@show')->name('admin.vacancies.show');
Route::get('/admin/vacancies/edit/{id}/edit', 'App\Http\Controllers\AdminVacancyController@edit')->name('admin.vacancies.edit');
